...
<body>
			...
			<div class="sixteen columns page-title">
				...
				<div class="twelve columns">
					...
					<div class="post-preview">
						<!-- Post Title & Meta -->
						<h2><a  class="dark-link" id="LWNAME"></a></h2>
						<div class="post-meta">
							 来源： <span class="meta-author">第一作者：<a id="FIRSTAUTHOR"></a></span>
							  <span class="meta-author">第二作者：<a id="SECONDAUTHOR"></a></span>
							   <span class="meta-author">第三作者：<a id="THIRDAUTHOR"></a></span>
							   <span class="meta-author">其他作者：<a id="OTHERAUTHER"></a></span>
							   <span class="meta-author">所属学科：<a id="SUBJECT"></a></span>
							  <span class="meta-author">出版日期：<a id="PUNLISHDATE"></a></span>
							   <span class="meta-author">出版社：<a id="PUBLISHER"></a></span>
						</div>
						<!-- End Post Image -->
	...
	<script type="text/javascript">
		...
		function getId(){
			var LUNWEN_ID = ((window.location+"").split('LUNWEN_ID='))[1];
			$.ajax({
				type: "POST",
				url: 'web/getKeyan.do',
		    	data: {LUNWEN_ID:LUNWEN_ID,tm:new Date().getTime()},
				dataType:'json',
				cache: false,
				success: function(data){
					 $("#LWNAME").html(data.new.LWNAME);
					 $("#ENAME").html(data.new.ENAME);
					 $("#PUNLISHDATE").html(data.new.PUNLISHDATE);
					 $("#FIRSTAUTHOR").html(data.new.FIRSTAUTHOR);
					 $("#SECONDAUTHOR").html(data.new.SECONDAUTHOR);
					 $("#THIRDAUTHOR").html(data.new.THIRDAUTHOR);
					 $("#OTHERAUTHER").html(data.new.OTHERAUTHER);
					 $("#SUBJECT").html(data.new.SUBJECT);
					 $("#PUBLISHER").html(data.new.PUBLISHER);
					 $("#FILEPATH").html(data.new.FILEPATH);
				}
			});
