				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
								...
								<td><input type="text" name="XUELI" id="XUELI" value="${pd.XUELI}" maxlength="20" placeholder="这里输入学历" title="学历" style="width:98%;"/></td>							
								</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">研究方向:</td>
								<td><input type="text" name="FANGXIANG" id="FANGXIANG" value="${pd.FANGXIANG}" maxlength="50" placeholder="这里输入研究方向" title="研究方向" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">已发表论文:</td>
								<td><input type="text" name="PUBPAPER" id="PUBPAPER" value="${pd.PUBPAPER}" maxlength="500" placeholder="这里输入已发表论文" title="已发表论文" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="ZHICHENG" id="ZHICHENG" value="${pd.ZHICHENG}" maxlength="20" placeholder="这里输入职称" title="职称" style="width:98%;"/></td>
							</tr>
							<tr>
							<td style="width:79px;text-align: right;padding-top: 13px;">性别:</td>
							<td>	<select name="SEX" title="性别">
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">学术兼职:</td>
								<td><input type="text" name="XSJZ" id="XSJZ" value="${pd.XSJZ}" maxlength="50" placeholder="这里输入学术兼职" title="学术兼职" style="width:98%;"/></td>
							</tr>
								<tr>
										<tr>
