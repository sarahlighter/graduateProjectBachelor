...
<body>
				...
				<!-- Post 1 -->
					<div class="post-preview preview-medium">
						...
						<div class="twelve columns omega">						
							<h2><a class="dark-link">科研项目 </a></h2>
							<#list xiangmuList as xiangmuList>
							<p>
							项目名称：${xiangmuList[1]}		项目来源：${xiangmuList[2]}		项目性质：${xiangmuList[3]}	
							</p>
							</#list>
						</div>
        				<div class="clearfix"></div>
					...
					<div class="post-preview preview-medium">
						<!-- Post Title & Meta -->
						<div class="twelve columns omega">																		
							<h2><a class="dark-link">论文成果</a></h2>
							<#list lunwenList as lunwenList>
							<p>
							论文名：《${lunwenList[1]}》 论文英文名：${lunwenList[2]}
							</p>
							</#list>
						</div>
        				<div class="clearfix"></div>
					...
					<div class="post-preview preview-medium">
						<!-- Post Title & Meta -->
						<div class="twelve columns omega">						
							<h2><a class="dark-link">专利成果</a></h2>
							<#list zhuanichengguolist as zhuanichengguolist>							
							<p>
							专利成果：${zhuanichengguolist[2]}   专利号：${zhuanichengguolist[1]}
							</p>
							</#list>
						</div>
        				<div class="clearfix"></div>
					...
					<div class="post-preview preview-medium">
						<!-- Post Title & Meta -->
						<div class="twelve columns omega">						
							<h2><a class="dark-link">其他科研成果</a></h2>
							<#list chengguoList as chengguoList>
							<p>
							项目名称：${chengguoList[1]}		
							</p>
							</#list>
	...
	<script type="text/javascript">
		$(window).load(function() {
			$("#allwork").addClass("current_page_item"); 
		});
	</script>
	<!-- End Document  -->
</body>
