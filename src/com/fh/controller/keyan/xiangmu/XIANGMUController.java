package com.fh.controller.keyan.xiangmu;
...
public class XIANGMUController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		//pd.put("STARTDATE", Tools.date2Str(new Date()));	//开始日期
		//pd.put("JIESHURIQI", Tools.date2Str(new Date()));	//结束日期
	...
	public ModelAndView list(Page page) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"列表XIANGMU");
		...
		mv.setViewName("keyan/xiangmu/xiangmu_list");
		mv.addObject("userList",userList);
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("keyan/xiangmu/xiangmu_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var1", varOList.get(i).getString("XMNAME"));	    //1
			vpd.put("var2", varOList.get(i).getString("FUZEREN"));	    //2
			vpd.put("var3", varOList.get(i).getString("CHENGDAN"));	    //3
			vpd.put("var4", varOList.get(i).getString("LAIYUAN"));	    //4
			vpd.put("var5", varOList.get(i).getString("XINGZHI"));	    //5
			vpd.put("var6", varOList.get(i).getString("STARTDATE"));	    //6
			vpd.put("var7", varOList.get(i).getString("JIESHURIQI"));	    //7
			vpd.put("var8", varOList.get(i).getString("SHENQINGZT"));	    //8
			varList.add(vpd);
		}
