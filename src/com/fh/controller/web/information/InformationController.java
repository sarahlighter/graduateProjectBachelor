package com.fh.controller.web.information;
...
public class InformationController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("web/information/information_list");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var5", varOList.get(i).getString("LOGO"));	    //5
			...
			vpd.put("var10", varOList.get(i).getString("WEBURL"));	    //10
			vpd.put("var11", varOList.get(i).getString("ADDRESS"));	    //11
			vpd.put("var12", varOList.get(i).getString("COPYRIGHT"));	    //12
			vpd.put("var13", varOList.get(i).getString("TECHNOLOGY"));	    //13
			vpd.put("var14", varOList.get(i).getString("BEIAN"));	    //14
			varList.add(vpd);
		}
